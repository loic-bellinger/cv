...
export default defineI18nLocale(async () => {
  return {
    ...
    initials: 'AJ',
    location: {
      text: 'Berlin, Germany, CEST',
      ariaLabel: 'View map of Berlin, Germany',
      ariaDescribedBy: 'Opens Google Maps in a new tab',
    ...
    contacts: [
      {
        ariaLabel: 'Send an email to Alex Johnson',
        ariaDescribedBy: 'Opens default mail client with a new message addressed to Alex Johnson',
        href: 'mailto:alex.johnson@example.com',
        icon: 'i-lucide-mail'
      },
      {
        ariaLabel: 'Call Alex Johnson by phone',
        ariaDescribedBy: 'Initiates a phone call on supported devices',
        href: 'tel:+4915123456789',
        icon: 'i-lucide-phone'
      },
      {
        ariaLabel: 'Visit Alex Johnson’s GitHub profile',
        ariaDescribedBy: 'Opens GitHub in a new tab',
