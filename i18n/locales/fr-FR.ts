...
export default defineI18nLocale(async () => {
  return {
    ...
    contacts: [
      {
        ariaLabel: 'Envoyer un email à @:name',
        ariaDescribedBy: 'Ouvre le client mail par défaut avec un nouveau message pour @:name',
        href: 'mailto:alex.johnson@example.com',
        icon: 'i-lucide-mail'
      },
      {
        ariaLabel: 'Appeler @:name',
        ariaDescribedBy: 'Initie un appel téléphonique sur les appareils compatibles',
        href: 'tel:+4915123456789',
        icon: 'i-lucide-phone'
      },
      {
        ariaLabel: 'Visiter le profil GitHub d’@:name',
        ariaDescribedBy: 'Ouvre GitHub dans un nouvel onglet',
        href: 'https://github.com/alexjohnson',
        icon: 'i-lucide-github'
      },
      {
        ariaLabel: 'Visiter le profil LinkedIn d’@:name',
